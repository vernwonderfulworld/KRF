            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <div class="row">
                            <div class="col-md-3" style="margin-lefttop:7px;">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3" style="margin-top:7px;">
                                <label class="control-label">Price per Kilo:</label>
                            </div>
                            <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-3" style="margin-top:7px;">
                                <label class="control-label">Price Per Box:</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="<?php echo $row['pricebox']; ?>" name="pricebox">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
